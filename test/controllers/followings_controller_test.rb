...
class FollowingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create following" do
    assert_difference('Following.count') do
      post followings_url, params: { following: { followed_id_id: @following.followed_id_id, follower_id_id: @following.follower_id_id } }
    end
  ...
  test "should update following" do
    patch following_url(@following), params: { following: { followed_id_id: @following.followed_id_id, follower_id_id: @following.follower_id_id } }
